...
<div id="mainQuestionModal">
	<form id="mainForm">
		...
		<div class="row m-1">
			...
			<input type="number" name="purchase_limit_container" id="purchase_limit_container" class="col-md form-control form-control-sm" placeholder="Purchasable limit"></input>
		</div>
...
<script type="text/javascript">
	...
	var daysContainer = ajaxShortLink('test-account/daily/getAddDays');
	...
	$('#token_name_container').on('change',function(){
		...
		var data = ajaxShortLink('test-account/daily/getDailySettings');
	...
	$("#mainForm").validate({
	  	...
	  	submitHandler: function(form){
		    ...
		    data.push({
      		...
      		var res = ajaxShortLink('test-account/daily/saveNewDailyToken',data);
