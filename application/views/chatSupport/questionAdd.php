...
<div id="pagetitle_background" class="pagetitle">
	<label class="h2 mt-2 fw-bold">Add Question</label>
</div>
...
<script type="text/javascript">
	...
	$("#mainForm").validate({
        ...
        $("#loading_text").text('Adding new question... Please wait')
				$("#loading").toggle();

		    var res = ajaxShortLink('admin/addQuestion',data);
		    console.log(data);
