...
<div id="pagetitle_background" class="pagetitle">
	<label class="h2 mt-2 fw-bold">Purchase Details (Wise Method)</label>
</div>
...
<div id="mainQuestionModal">
	...
	<div class="row m-1 mb-3">
		<div class="col-md-3 pl-3"><b>Wise Receipt:</b></div>	
		<img id="receipt_container" src="" data-action="zoom">

		<a download href="/images/myw3schoolsimage.jpg" class="btn btn-success btn-sm btn-block" id="download_btn">Download Image</a>
...
<script type="text/javascript">
	...
	$("#receipt_container").attr("src","assets/imgs/wise_receipts/"+selectedData.receiptPath);
	$("#download_btn").attr("href","assets/imgs/wise_receipts/"+selectedData.receiptPath);

	console.log(selectedData.receiptPath)
