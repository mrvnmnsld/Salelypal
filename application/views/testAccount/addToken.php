...
<script type="text/javascript">
	...
	var tokensSelected = ajaxShortLink('test-account/getAllSelectedTokens',{'userID':currentUser['userID']});
	...
	$("#save_token_mngmt_btn").on("click", function(){
		...
		if (container.checked.length ==0) {
			...
			var res = ajaxShortLink("test-account/updateTokenManagement",{'tokenIDSelected':container.checked.toString(),'userID':currentUser['userID']})
			tokensSelected = ajaxShortLink('test-account/getAllSelectedTokensVer2',{'userID':currentUser.userID});
