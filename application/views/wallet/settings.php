<div class="p-2">
	<div class="text-primary mb-2 font-weight-bold h5">Security</div>
...
<div class="p-2">
	...
	<button class="btn text-dark border-bottom btn-block text-left" disabled style="font-size: 18px;">
